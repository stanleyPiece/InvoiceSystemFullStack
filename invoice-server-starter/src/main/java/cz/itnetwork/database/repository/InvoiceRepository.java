...
public interface InvoiceRepository extends JpaRepository<InvoiceEntity, Long>, JpaSpecificationExecutor<InvoiceEntity> {
    ...
    /**
     * Method used in statistics
     * sums the price of all invoices in a given year, sums the price of all invoices, and counts the number of invoices
     *
     * @return sum of prices in a given year, sum of prices of all invoices, number of invoices
     */
